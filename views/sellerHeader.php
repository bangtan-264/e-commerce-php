    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-list">
          ...
          <?php
          if (!isset($_SESSION['s_id'])||$_SESSION['u_status']==="buyer") {
          ?>
            <li class="nav-item">
              <a class="nav-link" href="/sellerLogin">login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/sellerSignup">Signup</a>
            </li>
        </ul>
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-list">
          <li class="nav-item">
        ...
        ?>
          <li class="nav-item">
            <a class="nav-link" href="/sellerLogout">logout</a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav-list">
          ...
          <li class="nav-item">
            <a  href="/addProductsPage" class="nav-link">My Products</a>
          </li>
          <li class="nav-item">
            <a href="/orderedProducts" class="nav-link">My Orders</a>
          </li>
